...
part of 'filter_products_api_service.dart';
...
class _FilterProductsApiService implements FilterProductsApiService {
  _FilterProductsApiService(this._dio, {this.baseUrl, this.errorLogger}) {
