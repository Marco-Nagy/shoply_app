...
@injectable
class SignUpWithEmailCase {
  final AuthRepository _authRepository;
  SignUpWithEmailCase(this._authRepository);

  Future<DataResult<AuthUser>> call(SignupRequest body) async {
    final response = await _authRepository.signIn(AuthProviderType.email, signupRequest: body);
    return response;
  }
