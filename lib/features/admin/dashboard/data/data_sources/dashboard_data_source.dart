...
class DashboardDataSource {
  ...
  Future<TotalProductsResponse> getTotalProducts() async {
    return await _dashboardApiService
        .getTotalProducts(DashboardQueries().totalProductsQueries());
  }

  Future<TotalCategoriesResponse> getTotalCategories() async {
    return await _dashboardApiService
        .getTotalCategories(DashboardQueries().totalCategoriesQueries());
  }

  Future<TotalUsersResponse> getTotalUsers() async {
    return await _dashboardApiService
        .getTotalUsers(DashboardQueries().totalUsersQueries());
  }
}
