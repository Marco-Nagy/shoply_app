...
class _AdminCategoriesApiService implements AdminCategoriesApiService {
  _AdminCategoriesApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<DeleteCategoryResponse> deleteCategory(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(mutation);
    final _options = _setStreamType<DeleteCategoryResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/graphql',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteCategoryResponse _value;
    try {
      _value = DeleteCategoryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
